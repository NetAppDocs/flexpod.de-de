...
+
image:express-c-series-aff220-deploy_image8.png["Ein Screenshot eines Cisco-Server-Startbildschirms, der Benutzer dazu auffordert, F8 für die CIMC-Einrichtung zu drücken"]
...
*** Keine: [X]
+
image:express-c-series-aff220-deploy_image9.png["Ein Screenshot der Cisco IMC NIC-Eigenschaften mit IPv4-Einstellungen und ohne ausgewählte NIC Redundanz"]
...
+
image:express-c-series-aff220-deploy_image10.png["Ein Screenshot des Cisco IMC Configuration Utility, der allgemeine Eigenschaften und Porteinstellungen zeigt"]
...
+
image:express-c-series-aff220-deploy_image11.png["Ein Screenshot der Cisco Integrated Management Controller BIOS-Einstellungen mit ausgewählter Option \"Configure Boot Order\""]
...
+
image:express-c-series-aff220-deploy_image12.png["Ein Screenshot der erweiterten Boot Order Konfiguration mit aktiviertem KVM-MAPPED-DVD, iSCSI-A und iSCSI-B"]
...
+
image:express-c-series-aff220-deploy_image13.png["Ein Screenshot, der die CIMC BIOS-Einstellungen mit deaktiviertem Option ROM für PCIe Slot 1 und Slot 2 zeigt"]
...
+
image:express-c-series-aff220-deploy_image14.png["Ein Screenshot, der die iSCSI-vNIC-A Einstellungen mit MTU 9000, VLAN 3439, Trunk-Modus und aktiviertem PXE-Boot zeigt"]
...
+
image:express-c-series-aff220-deploy_image15.png["Ein Screenshot, der iSCSI-vNIC-A mit erweiterten iSCSI Boot-Eigenschaften auf der Registerkarte „vNICs“ zeigt."]
...
+
image:express-c-series-aff220-deploy_image16.png["Ein Screenshot der Cisco UCS iSCSI Boot-Eigenschaften zeigt die Felder Initiatorname, IP-Adresse, Subnetzmaske und Gateway."]
...
+
image:express-c-series-aff220-deploy_image17.png["Ein Screenshot, der die iSCSI vNIC-Initiatoreinstellungen mit primären und sekundären NetApp-Zielen zeigt"]
...
+
image:express-c-series-aff220-deploy_image18.png["Ein Screenshot der Cisco VIC vNICs Registerkarte, die eth0, eth1 und zwei iSCSI vNICs auflistet"]

. Wählen Sie eth0 aus, und klicken Sie auf Eigenschaften.
. Setzen Sie die MTU auf 9000. Klicken Sie Auf Änderungen Speichern.
+
image:express-c-series-aff220-deploy_image19.png["Ein Screenshot der Cisco VIC eth0 vNIC-Eigenschaften mit dem MTU-Feld auf 9000"]

. Wiederholen Sie die Schritte 3 und 4 für eth1. Überprüfen Sie, ob der Uplink-Port auf festgelegt ist `1` Für eth1.
+
image:express-c-series-aff220-deploy_image20.png["Ein Screenshot, der die Registerkarte „vNICs“ zeigt, mit MTU für eth0 und eth1 auf 9000 und Uplink-Ports 0 und 1."]
