...
. Klicken Sie auf OK.
+
image:express-c-series-aff220-deploy_image49.png["Ein Screenshot des Dialogfelds „Neuer Cluster“ mit aktiviertem DRS und vSphere HA für Cluster Tiger3"]
...
+
image:express-c-series-aff220-deploy_image50.png["Ein Screenshot des vSphere Webclients, der das FlexPod Cluster-Aktionsmenü mit ausgewählter Option „Host hinzufügen“ zeigt"]
