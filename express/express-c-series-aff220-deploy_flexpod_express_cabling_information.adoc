...
image:express-c-series-aff220-deploy_image5.png["Ein Diagramm, das Cisco Nexus Switches, Cisco UCS Server und NetApp AFF A220 Controller mit hervorgehobenen 10GbE-Ports zeigt"]
