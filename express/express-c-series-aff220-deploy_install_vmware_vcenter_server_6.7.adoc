...
+
image:express-c-series-aff220-deploy_image41.png["Ein Screenshot der VMware ESXi Host-Seite mit der hervorgehobenen Schaltfläche „vCenter Server abrufen“"]
...
+
image:express-c-series-aff220-deploy_image42.png["Ein Screenshot der Auswahl des vCenter Server Appliance-Bereitstellungstyps mit ausgewähltem Embedded Platform Services Controller"]
...
+
image:express-c-series-aff220-deploy_image43.png["Ein Screenshot der vCenter Server Appliance-Bereitstellungszielseite mit den Feldern für ESXi-Host, Port, Root-Benutzer und Passwort"]
...
+
image:express-c-series-aff220-deploy_image44.png["Ein Screenshot der Seite „Set up appliance VM“ mit den Feldern für VM-Name und Root-Passwort"]

. Wählen Sie die Implementierungsgröße aus, die am besten zu Ihrer Umgebung passt. Klicken Sie Auf Weiter.
+
image:express-c-series-aff220-deploy_image45.png["Ein Screenshot der vCenter Server-Bereitstellungsgrößenseite mit den Speicheroptionen Tiny und Default ausgewählt"]

. Wählen Sie den Infra_Datastore_1 aus. Klicken Sie Auf Weiter.
+
image:express-c-series-aff220-deploy_image46.png["Ein Screenshot der Seite „Datenspeicher auswählen“ des vCenter Server-Installationsprogramms mit ausgewähltem „infra_datastore_1“"]
...
+
image:express-c-series-aff220-deploy_image47.png["Ein Screenshot des vCenter Server Appliance Installers mit ausgefüllten statischen IPv4-Feldern in den Netzwerkeinstellungen"]
...
+
image:express-c-series-aff220-deploy_image48.png["Ein Screenshot der vCenter Server Appliance Einführungsseite Phase 2 mit einer Schaltfläche „Weiter“"]
