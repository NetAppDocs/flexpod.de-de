...
+
image:express-c-series-aff220-deploy_image6.png["Ein Screenshot der Clusterkonfigurationsfelder der geführten Einrichtung von System Manager für zwei HA-Paarknoten und Lizenzen"]
...
+
image:express-c-series-aff220-deploy_image7.png["Ein Screenshot der OnCommand System Manager Support-Konfiguration mit AutoSupport und Ereignisbenachrichtigungsfeldern"]
