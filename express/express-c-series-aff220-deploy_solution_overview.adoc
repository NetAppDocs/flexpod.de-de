...
image:express-c-series-aff220-deploy_image3.png["Ein Diagramm, das FlexPod Express, Datacenter und Select Lösungen, Ziele und Infrastrukturkomponenten vergleicht"]
...
image:express-c-series-aff220-deploy_image4.png["Ein Diagramm, das die Verbindungen zwischen Cisco Nexus 3172P Switches, UCS C220 M5 Servern und AFF A220 Speichersystemen zeigt"]
