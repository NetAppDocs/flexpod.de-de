...
+
image:express-c-series-aff220-deploy_image21.png["Ein Screenshot der Cisco CIMC Server BIOS-Seite mit dem Link „KVM starten“ im oberen Menü"]
...
=== ESXi 6.7 Cisco Custom Image herunterladen

. Navigieren Sie zum  https://support.broadcom.com/group/ecx/downloads["Downloadseite des Broadcom Supportportals"^]für benutzerdefinierte ISOs.
...
+
image:express-c-series-aff220-deploy_image22.png["Ein Screenshot des ESXi-Installationsprogramms, das ein NETAPP LUN C-Mode Speichergerät mit 15,00 GiB Kapazität auswählt"]
...
+
image:express-c-series-aff220-deploy_image23.png["Ein Screenshot des ESXi Netzwerkadaptermenüs, in dem vmnic0 und vmnic1 für vSwitch0 ausgewählt sind."]
...
+
image:express-c-series-aff220-deploy_image24.png["Ein Screenshot der Registerkarte „Virtuelle Switches“ im ESXi-Netzwerk, der vSwitch0 und iScsiBootvSwitch zeigt"]
...
+
image:express-c-series-aff220-deploy_image25.png["Ein Screenshot des Formulars „VMkernel-Netzwerkkarte hinzufügen“ zur Konfiguration von iScsiBootPG-B mit statischen IPv4-Einstellungen und MTU 9000"]
...
+
image:express-c-series-aff220-deploy_image26.png["Ein Screenshot der VMware ESXi Storage Adapters-Seite mit dem ausgewählten iSCSI Softwareadapter vmhba64"]

. Klicken Sie unter dynamische Ziele auf dynamische Ziele hinzufügen.
+
image:express-c-series-aff220-deploy_image27.png["Ein Screenshot des Dialogfelds „iSCSI konfigurieren“ mit „Dynamisches Ziel hinzufügen“ unter „Dynamische Ziele“"]
...
+
image:express-c-series-aff220-deploy_image28.png["Ein Screenshot, der vier iSCSI dynamische Ziel-IP-Adressen zeigt, die jeweils Port 3260 verwenden"]
...
+
image:express-c-series-aff220-deploy_image29.png["Ein Screenshot der VMware ESXi vSwitch0 Seite mit MTU 1500 und zwei aktiven physischen Adaptern"]
...
+
image:express-c-series-aff220-deploy_image30.png["Ein Screenshot der ESXi Networking-Seite mit ausgewähltem Tab „Portgruppen“ und der Option „Portgruppe hinzufügen“"]
...
+
image:express-c-series-aff220-deploy_image31.png["Ein Screenshot der Registerkarte „ESXi Networking VMkernel NICs“, auf der die Adapter vmk0 und vmk1 aufgelistet sind."]
...
** Klicken Sie auf Erstellen .
+
image:express-c-series-aff220-deploy_image32.png["Ein Screenshot des Formulars „VMkernel NIC hinzufügen“, in dem die NFS-Network Portgruppe mit statischen IPv4-Einstellungen konfiguriert wird"]
...
+
image:express-c-series-aff220-deploy_image33.png["Ein Screenshot des Dialogfelds „VMkernel-Netzwerkkarte hinzufügen“ mit statischen IPv4-Einstellungen und ausgewähltem vMotion"]
...
+
image:express-c-series-aff220-deploy_image34.png["Ein Screenshot der VMware ESXi Storage-Seite mit der sichtbaren Schaltfläche „Neuer Datenspeicher“"]

. Wählen Sie Mount NFS Datastore aus.
+
image:express-c-series-aff220-deploy_image35.png["Ein Screenshot des Assistenten für neuen Datenspeicher, bei dem als Erstellungstyp „NFS-Datenspeicher einbinden“ ausgewählt ist"]
...
+
image:express-c-series-aff220-deploy_image36.png["Ein Screenshot der ESXi-Seite „Systemzeit und Datum verwalten“, der den NTP-Clientstatus und die NTP-Server anzeigt"]
...
+
image:express-c-series-aff220-deploy_image37.png["Ein Screenshot des Dialogfelds „Zeitkonfiguration bearbeiten“ mit aktiviertem NTP und einem eingegebenen NTP-Server"]
...
+
image:express-c-series-aff220-deploy_image38.png["Ein Screenshot der VMware ESXi Manage System Swap-Seite mit angezeigten Auslagerungseinstellungen"]

. Klicken Sie Auf Einstellungen Bearbeiten. Wählen Sie Infra_swap aus den Datenspeicheroptionen aus.
+
image:express-c-series-aff220-deploy_image39.png["Ein Screenshot des Dialogfelds „Swap-Konfiguration bearbeiten“ mit „infra_swap“ als Datenspeicher ausgewählt sowie den Schaltflächen „Speichern“ und „Abbrechen“"]
...
+
image:express-c-series-aff220-deploy_image40.png["Ein Terminal zeigt die erfolgreiche NetApp NFS Plug-in VIB-Installation und eine Meldung, dass ein Neustart erforderlich ist"]
