...
image:express-c-series-aff220-design_image2.png["Ein Diagramm, das FlexPod Express, Datacenter und Select Plattformen mit Zielbereitstellungen und Komponenten zeigt"]
