...
image:express-c-series-aff220-design_image3.png["Ein Diagramm, das FlexPod Express Speicher-, Switching- und Compute-Hardwarefamilien mit Konfigurationsoptionen zeigt"]
...
image:express-c-series-aff220-design_image4.png["Ein Diagramm, das die Verbindungen zwischen Cisco Nexus 3172P Switches, UCS C220 M5 Servern und AFF A220 Speichersystemen zeigt"]
