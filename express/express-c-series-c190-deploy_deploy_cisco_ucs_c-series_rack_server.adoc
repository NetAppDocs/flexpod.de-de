...
+
image:express-c-series-c190-deploy_image5.png["Ein Screenshot, der einen Cisco Server-Startbildschirm zeigt, auf dem Benutzer aufgefordert werden, F8 für die CIMC-Einrichtung zu drücken."]
...
+
image:express-c-series-c190-deploy_image6.png["Ein Screenshot der Cisco IMC Configuration Utility NIC-Eigenschaften mit ausgewählter dedizierter NIC und ohne Redundanz"]
...
+
image:express-c-series-c190-deploy_image7.png["Ein Screenshot der Seite „Bootreihenfolge konfigurieren“ des Cisco Integrated Management Controller BIOS"]
...
+
image:express-c-series-c190-deploy_image8.png["Ein Screenshot der erweiterten Boot Order Konfiguration mit aktiviertem KVM-MAPPED-DVD, iSCSI-A und iSCSI-B"]
...
+
image:express-c-series-c190-deploy_image9.png["Ein Screenshot, der die CIMC BIOS-Einstellungen mit deaktiviertem Option ROM für PCIe Slot 1 und Slot 2 zeigt"]
...
+
image:express-c-series-c190-deploy_image10.png["Screenshot der Cisco Integrated Management Controller Adapter Card MLOM Registerkarte „General“, bei der Port Channel nicht ausgewählt ist"]
...
+
image:express-c-series-c190-deploy_image11.png["Ein Screenshot, der die allgemeinen Einstellungen für iSCSI vNIC eth1 mit VLAN 3439 und Uplink Port 1 zeigt."]



. Wählen Sie links die vNIC eth1 aus.
+
image:express-c-series-c190-deploy_image12.png["Ein Screenshot, der die iSCSI-Boot-Eigenschaften Initiatoreinstellungen für die vNIC eth1 zeigt"]
...
+
image:express-c-series-c190-deploy_image13.png["Ein Screenshot der iSCSI Boot-Eigenschaften mit Details zu Initiator, primärem Ziel und sekundärem Ziel"]
...
+
image:express-c-series-c190-deploy_image14.png["Ein Screenshot, der die iSCSI Boot-Eigenschaften für vNIC eth3 mit Initiator- und Ziel-Einstellungen zeigt"]
...
+
image:express-c-series-c190-deploy_image15.png["Ein Screenshot der Eigenschaften der vNIC eth0 des Cisco Integrated Management Controller mit MTU 9000 und Standard-VLAN 2"]

. Wiederholen Sie die Schritte 3 und 4 für eth1. Überprüfen Sie, ob der Uplink-Port für eth1 auf 1 gesetzt ist.
+
image:express-c-series-c190-deploy_image16.png["Ein Screenshot der Cisco Integrated Management Controller vNICs, der eth0 bis eth3 mit MTU, Uplink-Port und VLAN-Einstellungen auflistet"]
