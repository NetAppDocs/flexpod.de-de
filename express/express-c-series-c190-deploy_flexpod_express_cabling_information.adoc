...
image:express-c-series-c190-deploy_image3.png["Ein Diagramm, das die Rückansichten von zwei Nexus Switches, zwei Cisco UCS Servern und AFF C190 Controllern zeigt"]
