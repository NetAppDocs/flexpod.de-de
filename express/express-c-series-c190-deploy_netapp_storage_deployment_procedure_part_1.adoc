...
+
image:express-c-series-c190-deploy_image4.png["Ein Screenshot der OnCommand System Manager Support-Konfiguration mit AutoSupport und Ereignisbenachrichtigungsfeldern"]
...
link:express-c-series-c190-deploy_deploy_cisco_ucs_c-series_rack_server.html["Weiter: Implementierung von Rack-Servern der Cisco UCS C-Serie"]
