...
+
image:express-c-series-c190-deploy_image49.png["Ein Screenshot des vSphere Client Deploy OVF Template mit einer im Dialogfeld „Öffnen“ ausgewählten VSC OVF-Datei"]
...
+
image:express-c-series-c190-deploy_image50.png["Ein Screenshot des Assistenten zum Bereitstellen der OVF-Vorlage mit dem VM-Namen FlexPod-VSC und FlexPod-Datacenter ausgewählt"]
...
+
image:express-c-series-c190-deploy_image51.png["Ein Screenshot, der den Schritt „Details überprüfen“ für die Bereitstellung der NetApp VSC OVF-Vorlage für virtuelle Appliances zeigt."]
...
+
image:express-c-series-c190-deploy_image52.png["Ein Screenshot der Seite „Speicher auswählen“ der Deploy OVF Template-Funktion mit Thin Provision und NFS-Datastores"]

. Wählen Sie unter Netzwerke auswählen ein Zielnetzwerk aus, und klicken Sie auf Weiter.
+
image:express-c-series-c190-deploy_image53.png["Ein Screenshot des Schritts „OVF-Vorlage bereitstellen Select networks“, bei dem nat dem MGMT-Network zugeordnet wird"]
...
+
image:express-c-series-c190-deploy_image54.png["Ein Screenshot der Seite „OVF-Vorlage bereitstellen Vorlage anpassen“ mit vCenter Registrierungsfeldern und Netzwerkeigenschaften"]
...
+
image:express-c-series-c190-deploy_image55.png["Eine VM-Konsole mit Anweisungen zur Installation von VMware Tools vor der Fortsetzung der Installation von VSC, VASA Provider und SRA"]
...
+
image:express-c-series-c190-deploy_image56.png["Ein Screenshot des vSphere Client-Menüs mit hervorgehobener Virtual Storage Console"]
...
+
image:express-c-series-c190-deploy_image57.png["Ein Screenshot von VSC NFS VAAI Tools mit einer zum Hochladen ausgewählten NetAppNasPlugin.vib-Datei"]
...
+
image:express-c-series-c190-deploy_image58.png["Ein Screenshot, der das NetApp VSC-Menü mit der ausgewählten Option „NFS Plug-in für VMware VAAI installieren“ zeigt"]
...
+
image:express-c-series-c190-deploy_image59.png["Ein Screenshot des vSphere Client-Host-Aktionsmenüs mit NetApp VSC Set Recommended Values ausgewählt"]
...
+
image:express-c-series-c190-deploy_image60.png["Ein Dialogfeld „Empfohlene Werte festlegen“ mit ausgewählten HBA/CNA Adapter, MPIO und NFS Einstellungen"]

+
image:express-c-series-c190-deploy_image61.png["Nach erfolgreicher Erkennung des Speichersystems erscheint ein Erfolgsdialog mit den geänderten ESXi Host Einstellungen."]
