...
image:express-c-series-c190-deploy_image1.png["Ein Diagramm, das die FlexPod Express und FlexPod Datacenter Portfoliooptionen mit Anwendungsfällen zeigt"]
...
image:express-c-series-c190-deploy_image2.png["Ein Diagramm, das FlexPod Express Switches, C220 M5 Server und AFF C190 Speicherverbindungen zeigt"]
