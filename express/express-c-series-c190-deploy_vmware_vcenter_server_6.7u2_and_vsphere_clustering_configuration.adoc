...
. Klicken Sie auf OK.
+
image:express-c-series-c190-deploy_image45.png["Ein Screenshot des Dialogfelds „Neuer Cluster“ mit aktiviertem DRS und vSphere HA sowie deaktiviertem vSAN"]
...
+
image:express-c-series-c190-deploy_image46.png["Ein Screenshot des vSphere Client-Assistenten zum Hinzufügen von Hosts mit einem Feld zur Eingabe des Host-FQDN und der Schaltfläche „Weiter“"]
...
. Melden Sie sich bei  `https://<vCenter IP>:5480` an, geben Sie root als Benutzernamen ein und geben Sie das Root-Passwort ein.
...
+
image:express-c-series-c190-deploy_image47.png["Ein Screenshot der Appliance Management Services mit ausgewähltem VMware vSphere ESXi Dump Collector und verfügbarer Option „Start“"]
...
+
image:express-c-series-c190-deploy_image48.png["Ein Terminalfenster mit ESXi Coredump Konfigurationsbefehlen und Netdump Server Überprüfung"]
