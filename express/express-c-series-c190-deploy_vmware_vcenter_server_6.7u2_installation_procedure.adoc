...
+
image:express-c-series-c190-deploy_image34.png["Ein Screenshot der Seite „Endbenutzer-Lizenzvereinbarung“ des vCenter Server Appliance Installers mit ausgewählter Annahmeoption"]

. Wählen Sie als Bereitstellungstyp den Embedded Platform Services Controller aus.
+
image:express-c-series-c190-deploy_image35.png["Ein Screenshot der Seite „Bereitstellungstyp“ des vCenter Server Appliance Installers mit ausgewähltem Embedded Platform Services Controller"]
...
+
image:express-c-series-c190-deploy_image36.png["Ein Screenshot des vCenter Server Appliance Installer-Bereitstellungszielformulars mit ESXi-Host-Anmeldeinformationen"]
...
+
image:express-c-series-c190-deploy_image37.png["Ein Screenshot der Seite „Appliance-VM einrichten“ des vCenter Server Appliance Installers mit den Feldern für VM-Name und Root-Passwort"]

. Wählen Sie die Implementierungsgröße aus, die am besten zu Ihrer Umgebung passt. Klicken Sie Auf Weiter.
+
image:express-c-series-c190-deploy_image38.png["Ein Screenshot der Seite „Select deployment size“ des vCenter Server Appliance Installers mit der Auswahl „Tiny“"]
...
+
image:express-c-series-c190-deploy_image39.png["Ein Screenshot der Seite „Netzwerkeinstellungen konfigurieren“ des vCenter Server Appliance Installers mit ausgewähltem MGMT-Network"]

. Überprüfen Sie Ihre Einstellungen in Phase 1, bevor Sie mit der Bereitstellung der Appliance beginnen.
+
image:express-c-series-c190-deploy_image40.png["Ein Screenshot der Seite „vCenter Server Appliance Installer: Bereit zum Abschließen von Phase 1 – Einstellungen überprüfen“"]
...
+
image:express-c-series-c190-deploy_image41.png["Ein Screenshot der vCenter Server Appliance Installer Einführungsseite von Phase 2 mit einer Schaltfläche „Weiter“"]
...
+
image:express-c-series-c190-deploy_image42.png["Ein Screenshot der vCenter Server Appliance Installer Stage 2 SSO-Konfiguration mit einer ausgewählten neuen SSO-Domäne"]
...
+
image:express-c-series-c190-deploy_image43.png["Ein Screenshot der Seite „CEIP konfigurieren“ des vCenter Server Appliance Installers, auf der die CEIP-Option ausgewählt ist"]
...
+
image:express-c-series-c190-deploy_image44.png["Ein Screenshot eines vCenter Server Appliance Installers mit einer Warnung, dass die Installation nicht pausiert oder gestoppt werden kann, mit Schaltflächen für Abbrechen und OK"]
