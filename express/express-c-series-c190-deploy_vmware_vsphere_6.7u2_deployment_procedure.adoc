...
+
image:express-c-series-c190-deploy_image17.png["Ein Screenshot der Cisco CIMC Server BIOS-Seite mit dem Link „KVM starten“ im oberen Menü"]
...
=== ESXi 6.7U2 Cisco Custom Image herunterladen
...
+
image:express-c-series-c190-deploy_image18.png["Ein Screenshot des ESXi-Installationsprogramms, das ein NETAPP LUN C-Mode Speichergerät mit 15,00 GiB Kapazität auswählt"]
...
+
image:express-c-series-c190-deploy_image19.png["Ein Screenshot der ESXi Netzwerkadapteransicht, auf dem vmnic2 und vmnic4 für das Management Networking ausgewählt sind"]
...
+
image:express-c-series-c190-deploy_image20.png["Ein Screenshot der ESXi Networking-Seite mit der Registerkarte „Virtuelle Switches“, auf der vSwitch0 und iScsiBootvSwitch angezeigt werden"]
...
+
image:express-c-series-c190-deploy_image21.png["Ein Screenshot der iSCSIBootPG-A Teaming- und Failover-Einstellungen mit aktivem vmnic3 und ungenutztem vmnic5"]
...
+
image:express-c-series-c190-deploy_image22.png["Ein Screenshot der Registerkarte „ESXi Storage Adapters“ mit dem ausgewählten iSCSI-Softwareadapter vmhba64"]

. Klicken Sie unter dynamische Ziele auf dynamische Ziele hinzufügen.
+
image:express-c-series-c190-deploy_image23.png["Ein Screenshot, der iSCSI dynamische Ziele mit vier IP-Adressen und dem konfigurierten Port 3260 zeigt"]
...
+
image:express-c-series-c190-deploy_image24.png["Ein Screenshot von vier dynamischen iSCSI-Zieladressen, die Port 3260 verwenden, und der Schaltfläche „Konfiguration speichern“"]
...
+
image:express-c-series-c190-deploy_image25.png["Ein Screenshot der ESXi vSwitch0-Seite mit MTU 9000 und den aktiven Adaptern vmnic2 und vmnic4"]
...
+
image:express-c-series-c190-deploy_image26.png["Ein Screenshot der ESXi Networking-Seite mit ausgewähltem Tab „Portgruppen“ und der Option „Portgruppe hinzufügen“"]
...
+
image:express-c-series-c190-deploy_image27.png["Ein Screenshot der Registerkarte „VMkernel-NICs“ im ESXi Networking, auf der die Schnittstellen vmk0 und vmk1 aufgelistet sind"]
...
+
image:express-c-series-c190-deploy_image28.png["Ein Screenshot des Dialogfelds „VMkernel-Netzwerkkarte hinzufügen“ mit statischen IPv4-Einstellungen und ausgewähltem vMotion"]
...
+
image:express-c-series-c190-deploy_image29.png["Ein Screenshot der VMware ESXi Storage-Seite mit der sichtbaren Schaltfläche „Neuer Datenspeicher“"]

. Wählen Sie Mount NFS Datastore aus.
+
image:express-c-series-c190-deploy_image30.png["Ein Screenshot des Assistenten für neuen Datenspeicher, bei dem als Erstellungstyp „NFS-Datenspeicher einbinden“ ausgewählt ist"]
...
. Klicken Sie auf Speichern .
+
image:express-c-series-c190-deploy_image31.png["Ein Screenshot, der die ESXi-Zeit- und Datumseinstellungen mit laufendem NTP-Service und drei NTP-Servern zeigt"]
...
+
image:express-c-series-c190-deploy_image32.png["Ein Screenshot der VMware ESXi Manage System Swap-Seite mit angezeigten Auslagerungseinstellungen"]

. Klicken Sie Auf Einstellungen Bearbeiten. Wählen Sie `infra_swap` In den Datastore-Optionen.
+
image:express-c-series-c190-deploy_image33.png["Ein Screenshot des Dialogfelds „Swap-Konfiguration bearbeiten“ mit „infra_swap“ als Datenspeicher ausgewählt sowie den Schaltflächen „Speichern“ und „Abbrechen“"]

. Klicken Sie auf Speichern .


link:express-c-series-c190-deploy_vmware_vcenter_server_6.7u2_installation_procedure.html["Weiter: VMware vCenter Server 6.7U2 Installationsverfahren."]
