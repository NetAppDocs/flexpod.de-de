...
image:express-c-series-c190-design_image4.png["Ein Diagramm, das die Rückansichten von zwei AFF C190 Controllern mit UTA 2 Ports für SFP+ Module zeigt"]

Die folgende Abbildung zeigt 10GBASE-T-Ports für den Anschluss über herkömmliche RJ-45 Ethernet-Kabel.

image:express-c-series-c190-design_image5.png["Ein Diagramm, das die Rückseite eines AFF C190 Systems mit 10GBASE-T RJ-45 Ports zeigt"]
...
Vollständige Informationen zum AFF C190 Hardware-System sind unter  https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190 Dokumentation"^] zu finden.
...
image:express-c-series-c190-design_image6.png["Ein Diagramm, das mehrere logische 4-KB-Blöcke zeigt, die in einem physischen 4-KB-Block zusammengefasst sind"]
...
image:express-c-series-c190-design_image7.png["Vorderansicht eines Cisco Nexus 31108PC-V Switches mit 48 SFP+ Ports und sechs QSFP28 Ports"]
...
image:express-c-series-c190-design_image8.png["Vorderansicht eines Cisco UCS C220 M5 Rack Servers mit zwei Laufwerksschächten und Cisco Branding"]
...
image:express-c-series-c190-design_image9.png["Ein Screenshot des Cisco UCS VIC 1457 Adapters mit vier SFP28 Ports und einem Lüfter"]
...
image:express-c-series-c190-design_image10.png["Ein Diagramm, das vier mit FlexPod und iSCSI-Boot-vSwitches verbundene vNICs auf einem VMware ESXi 6.7 U2 Host zeigt"]
