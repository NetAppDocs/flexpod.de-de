...
Befolgen Sie die physischen Installationsverfahren für die Controller im https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["AFF A220: Dokumentation"^].
...
+
image:express-direct-attach-aff220-deploy_image7.png["Ein Screenshot des Dialogfelds „Block von IPv4-Adressen erstellen“ mit den Feldern IP-Adresse, Subnetz, Gateway und DNS"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["Ein Screenshot des Dialogfelds „NTP Server hinzufügen“, in dem der NTP Server auf 10.1.156.4 eingestellt ist."]

. Klicken Sie auf NTP-Server hinzufügen.
. Eingabe `<switch-b-ntp-ip>` `or <Nexus-B-mgmt-IP>` Klicken Sie anschließend auf OK. Klicken Sie auf OK auf die Bestätigung.
+
image:express-direct-attach-aff220-deploy_image9.png["Ein Screenshot der Cisco UCS Manager NTP-Einstellungen mit zwei aufgelisteten NTP-Servern und der ausgewählten Zeitzone America/New_York"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["Ein Screenshot, der die Ethernet-Ports von Fabric Interconnect A mit konfigurierten Uplink- und Appliance-Speicherrollen zeigt"]
...
. Vergewissern Sie sich auf der Registerkarte Ethernet-Ports, dass die Ports in der Spalte „Wenn-Rolle“ richtig konfiguriert wurden. Wenn auf dem Skalierbarkeitsport Server der C-Serie konfiguriert wurden, klicken Sie darauf, um die Anschlussverbindung dort zu überprüfen.
+
image:express-direct-attach-aff220-deploy_image11.png["Ein Screenshot, der die Fabric Interconnect B Ethernet Ports mit konfigurierten Netzwerk- und Appliance-Speicherrollen zeigt."]
...
+
image:express-direct-attach-aff220-deploy_image12.png["Ein Screenshot des Dialogfelds „Port Channel erstellen“ mit der ID 1 und dem Namen „vPC-13-Nexus“"]
...
+
image:express-direct-attach-aff220-deploy_image13.jpeg["Ein Screenshot des Dialogfelds „VLANs erstellen“ mit NFS-VLAN und VLAN-ID 3170 eingetragen"]
...
. Klicken Sie auf OK, und klicken Sie erneut auf OK, um das VLAN zu erstellen.
+
image:express-direct-attach-aff220-deploy_image14.png["Ein Screenshot, der die VLAN-Tabelle im Cisco UCS Manager mit VLAN-Namen und IDs zeigt"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["Ein Screenshot, der die Netzwerksteuerungsrichtlinie Enable_CDP mit aktiviertem CDP- und LLDP-Senden und -Empfangen zeigt"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["Ein Screenshot der Eigenschaften von Appliance Interface 1/3 mit aktiviertem CDP und ausgewählten Storage-VLANs"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["Ein Screenshot der VLAN-Einstellungen der Appliance Interface 1/3 mit ausgewählten iSCSI-B, NFS und Native VLANs"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Ein Screenshot der Cisco UCS Manager QoS-Systemklasseneinstellungen mit Best Effort MTU auf 9216"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Ein Screenshot des Dialogfelds „Paketversionen ändern“, in dem „Blade Package 4.0(1b)B“ ausgewählt ist."]
...
+
image:express-direct-attach-aff220-deploy_image20.png["Ein Screenshot des Dialogfelds „MAC-Adressblock erstellen“ mit der MAC-Adresse 00:25:B5:32:0A:00 und Größe 64"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["Ein Screenshot des Dialogfelds „Create a Block of IQN Suffixes“ mit dem Suffix „ucs-host“, From 1 und Size 16."]
...
+
image:express-direct-attach-aff220-deploy_image22.png["Ein Screenshot des Dialogfelds „Netzwerksteuerungsrichtlinie erstellen“ mit aktiviertem CDP und LLDP"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["Ein Screenshot des Dialogfelds „Create Power Control Policy“ mit den ausgewählten Optionen „No-Power-Cap“ und „No Cap“."]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Screenshot des Cisco UCS Manager Dialogs „CPU/Kerne qualifizieren“ mit Xeon Prozessorarchitektur und CPU PID Feld"]
...
+
image:express-direct-attach-aff220-deploy_image25.png["Ein Screenshot des Dialogfelds „BIOS-Richtlinie erstellen“ mit aktiviertem VM-Hostnamen und aktivierter einheitlicher Gerätebenennung"]
...
+
image:express-direct-attach-aff220-deploy_image26.png["Ein Screenshot der Registerkarte „BIOS-Richtlinie erstellen“ mit deaktiviertem Prozessor C State und deaktiviertem C1E"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["Ein Screenshot, der die BIOS-Prozessoroptionen mit den Einstellungen Energie-Performance und DRAM-Taktdrosselung auf „Leistung“ zeigt"]
...
+
image:express-direct-attach-aff220-deploy_image28.png["Ein Screenshot der Seite „BIOS-Richtlinie RAS Memory erstellen“ mit auf „Performance Mode“ eingestelltem LV DDR Mode."]
...
+
image:express-direct-attach-aff220-deploy_image29.png["Ein Screenshot der Standardwartungsrichtlinie des Cisco UCS Manager mit den Optionen „Benutzerbestätigung“ und „Beim nächsten Neustart“"]
...
. Klicken Sie auf OK.
+
image:express-direct-attach-aff220-deploy_image30.png["Ein Screenshot der Cisco UCS Manager vNIC Vorlageneigenschaften für vNIC_Template_A auf Fabric A"]
...
. Klicken Sie auf OK.
+
image:express-direct-attach-aff220-deploy_image31.png["Ein Screenshot der Cisco UCS Manager vNIC Template B Einstellungen mit Fabric B, MTU 9000 und MAC Pool B ausgewählt"]
...
. Klicken Sie auf OK.
+
image:express-direct-attach-aff220-deploy_image32.png["Ein Screenshot der Site_01_iSCSI-A vNIC Vorlage mit Fabric A, MTU 9000 und MAC Pool A56/64 ausgewählt"]
...
. Klicken Sie auf OK.
+
image:express-direct-attach-aff220-deploy_image33.png["Ein Screenshot der Cisco UCS Manager vNIC Vorlage Site_01_iSCSI-B Einstellungen für Fabric B mit MTU 9000"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["Ein Screenshot, der den Dialog „vNIC ändern“ für Site-01-vNIC-A unter Verwendung von vNIC_Template_A und VMWare adapter policy zeigt."]
...
+
image:express-direct-attach-aff220-deploy_image35.png["Ein Screenshot des Dialogfelds „iSCSI vNIC ändern“ für Site-01-iSCSI-A mit VLAN- und MAC-Adresseinstellungen"]
...
. Klicken Sie Auf Änderungen Speichern.
+
image:express-direct-attach-aff220-deploy_image36.png["Ein Screenshot der LAN-Konnektivitätsrichtlinie Site-01-iSCSIBoot mit zwei iSCSI vNICs in der Liste"]
...
+
Dieses VMware ESXi 6.7U1 ISO kann von  https://support.broadcom.com/group/ecx/downloads["Broadcom Supportportal"^] heruntergeladen werden.
...
+
image:express-direct-attach-aff220-deploy_image37.png["Ein Screenshot des Dialogfelds „vMedia Mount erstellen“, konfiguriert mit einer HTTP-ESXi-Installer-ISO-Remote-Datei und Pfad"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["Ein Screenshot der Cisco UCS Manager Boot Policy Site-01-Fabric-A mit zwei konfigurierten iSCSI Boot-Einträgen"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["Ein Screenshot des Assistenten zum Erstellen einer Dienstprofilvorlage mit den Feldern Name, Aktualisierungsvorlage und UUID-Pool"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["Ein Screenshot der Netzwerkeinstellungen der Vorlage „Create Service Profile Template“ mit iSCSI-Boot-Konnektivität und ausgewähltem IQN_Pool"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Ein Screenshot der Seite „Create Service Profile Template Server Boot Order“ mit ausgewähltem Boot-Fabric-A"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Ein Screenshot der Ausgabe des Befehls iscsi show, der einen Infra-SVM-Ziel-IQN, Alias und den Status „up“ auflistet"]

. Geben Sie die IP-Adresse von ein `iscsi_lif_02a` Für das Feld IPv4-Adresse.
+
image:express-direct-attach-aff220-deploy_image43.png["Ein Screenshot des Dialogfelds „iSCSI Static Target erstellen“ mit der eingegebenen IPv4-Adresse 192.168.10.62"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["Ein Screenshot des Dialogfelds „Statisches iSCSI-Ziel erstellen“ mit der IPv4-Adresse 192.168.10.61 und LUN ID 0"]

. Klicken Sie auf OK, um das statische iSCSI-Ziel hinzuzufügen.
+
image:express-direct-attach-aff220-deploy_image45.png["Ein Screenshot des Dialogfelds „Set iSCSI Boot Parameters“ mit ausgewählten statischen iSCSI-Ziel-Interfaces"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["Ein Screenshot des Dialogfelds „iSCSI Static Target erstellen“ mit der IPv4-Adresse auf 192.168.20.62 gesetzt."]
...
+
image:express-direct-attach-aff220-deploy_image47.png["Ein Screenshot des Dialogfelds „Statisches iSCSI-Ziel erstellen“ mit der IPv4-Adresse 192.168.20.61 und LUN ID 0"]

. Klicken Sie auf OK, um das statische iSCSI-Ziel hinzuzufügen.
+
image:express-direct-attach-aff220-deploy_image48.png["Ein Screenshot, der zwei statische iSCSI-Zielschnittstellen zeigt, die in „iSCSI-Bootparameter festlegen“ ausgewählt sind."]
...
+
image:express-direct-attach-aff220-deploy_image49.png["Ein Screenshot des Schritts „Wartungsrichtlinie für Dienstprofilvorlagen erstellen“ mit der Standardrichtlinie als Auswahl."]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Screenshot der Erstellung der Serviceprofilvorlage-Serverzuweisung mit ausgewähltem Infra-Pool, ausgeschaltetem Stromzustand und Standard-Firmwarepaket"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["Ein Screenshot der Seite „Betriebsrichtlinien für Dienstprofilvorlagen erstellen“ mit VM-Host-BIOS und Keine Leistungsbegrenzung ausgewählt"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["Ein Screenshot des Dialogfelds „Create Service Profiles From Template“ mit dem Präfix Site-01-Infra-0, der Nummer 2 und der Stammorganisation"]
...
. Melden Sie sich auf der Downloadseite des Broadcom Supportportals an: https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^].
. Sie benötigen eine Broadcom-Benutzerkennung und ein Passwort. Suchen Sie nach VMware vSphere Hypervisor (ESXi) Custom ISOs.
. Laden Sie das Cisco Custom Image für die ESXi 6.7U1 Installations-CD herunter.
...
+
image:express-direct-attach-aff220-deploy_image53.png["Ein Screenshot des ESXi Netzwerkadapter-Bildschirms, auf dem vmnic0 und vmnic1 ausgewählt und verbunden sind"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["Ein Screenshot, der die Details und die Topologie von vSwitch0 mit VMkernel-Adaptern und zwei physischen Adaptern zeigt"]
...
+
image:express-direct-attach-aff220-deploy_image55.png["Ein Screenshot der Registerkarte „ESXi VMkernel NICs“, auf der fünf VMkernel-Adapter und ihre Portgruppen aufgeführt sind"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["Ein Screenshot der Registerkarte „ESXi Storage Adapters“ mit dem ausgewählten iSCSI-Softwareadapter vmhba64"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["Ein Screenshot des Dialogfelds „iSCSI konfigurieren“, der vier dynamische und statische iSCSI-Ziele an Port 3260 zeigt"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["Ein Screenshot des Assistenten für neuen Datenspeicher, bei dem als Erstellungstyp „NFS-Datenspeicher einbinden“ ausgewählt ist"]
...
.. Klicken Sie Auf Weiter.
+
image:express-direct-attach-aff220-deploy_image59.png["Ein Screenshot der Seite „NFS-Mountdetails bereitstellen“ mit infra_datastore_1 und NFS-Server 192.168.104.3"]
...
. Klicken Sie Auf Fertig Stellen. Der Datastore sollte nun in der Datastore-Liste angezeigt werden.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["Ein Screenshot der ESXi Storage-Datenspeicherliste, der infra_datastore_2 als NFS-Datenspeicher eingebunden zeigt"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["Ein Screenshot des Dialogfelds „Zeitkonfiguration bearbeiten“ mit aktiviertem NTP und zwei eingegebenen NTP-Serveradressen"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["Ein Screenshot der VMware ESXi Manage System Swap-Seite mit den Swap-Einstellungen und den Einstellungen zum Bearbeiten"]

. Klicken Sie Auf Einstellungen Bearbeiten. Wählen Sie `infra_swap` In den Datastore-Optionen.
+
image:express-direct-attach-aff220-deploy_image63.png["Ein Screenshot des Dialogfelds „Swap-Konfiguration bearbeiten“ mit ausgewähltem infra_swap Datenspeicher und den Schaltflächen „Speichern“ und „Abbrechen“"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["Ein Screenshot des ESXi Host Navigators mit der hervorgehobenen Schaltfläche „vCenter Server abrufen“"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["Ein Screenshot der Seite „Select deployment type“ des vCenter Server Appliance Installers mit ausgewähltem Embedded Platform Services Controller"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["Ein Screenshot der Seite des VCenter Server Appliance Installers für das Appliance-Bereitstellungsziel mit eingegebenen ESXi-Host-Anmeldedaten"]
...
+
image:express-direct-attach-aff220-deploy_image67.png["Ein Screenshot der Seite „Appliance-VM einrichten“ des vCenter Server Appliance Installers mit den Feldern für VM-Name und Root-Passwort"]

. Wählen Sie die Implementierungsgröße aus, die am besten zu Ihrer Umgebung passt. Klicken Sie Auf Weiter.
+
image:express-direct-attach-aff220-deploy_image68.png["Ein Screenshot der Seite „Select deployment size“ des vCenter Server Appliance Installers mit der Auswahl „Tiny“"]

. Wählen Sie die aus `infra_datastore_1` Datenspeicher: Klicken Sie Auf Weiter.
+
image:express-direct-attach-aff220-deploy_image69.png["Ein Screenshot der vCenter Server Appliance Installer-Seite „Datenspeicher auswählen“, auf der infra_datastore_1 unter drei Datenspeichern aufgeführt ist"]
...
+
image:express-direct-attach-aff220-deploy_image70.png["Ein Screenshot der Seite „Netzwerkeinstellungen konfigurieren“ des vCenter Server Appliance Installers mit statischen IPv4-Details"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["Ein Screenshot, der die erfolgreiche Bereitstellung des Stage 1 vCenter Servers mit einer Schaltfläche „Weiter“ zeigt"]
...
. Klicken Sie auf OK.
+
image:express-direct-attach-aff220-deploy_image72.png["Ein Screenshot des Dialogfelds „Neuer Cluster“ mit aktiviertem DRS und vSphere HA für den Express Cluster"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["Ein Screenshot des vSphere Client-Aktionsmenüs für den Express Cluster mit ausgewählter Option „Hosts hinzufügen“"]
