...
image:express-direct-attach-aff220-deploy_image2.png["Ein Diagramm, das die Lösungen FlexPod Express, FlexPod Datacenter und FlexPod Select vergleicht"]
...
image:express-direct-attach-aff220-deploy_image3.png["Ein Diagramm, das FlexPod Express Server, Nexus Switches und AFF Speicherverkabelung für Management-, Daten-, IP-, Cluster-Interconnect- und vPC-Peer-Netzwerke zeigt"]
