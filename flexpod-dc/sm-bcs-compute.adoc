...
image:sm-bcs-image17.png["Ein Diagramm, das UCS 2204XP A und B zeigt, die über 10GBASE-KR mit einem B200 M5 VIC verbunden sind."]
...
image:sm-bcs-image18.png["Ein Diagramm, das UCS 5108 IOMs zeigt, die mit FI 6454 Switches sowie Nexus A und B Switches verbunden sind"]
...
image:sm-bcs-image19.png["Ein Screenshot, der den Dialog „iSCSI-Bootparameter festlegen“ des Cisco UCS Manager mit zwei statisch konfigurierten Zielen zeigt"]
