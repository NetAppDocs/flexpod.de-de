...
image:sm-bcs-image4.png["Ein Diagramm, das die FlexPod Standorte A und B mit einer Latenz von bis zu 10 ms und einen ONTAP Mediator an Standort C zeigt"]
...
image:sm-bcs-image5.png["Ein Diagramm, das Cisco UCS C240/C245, C220/C225, B200 und X210c M6 Server zeigt"]
...
image:sm-bcs-image6.png["Ein Diagramm, das Vorderansichten der UCS 2408, 2304, 2208XP, 2204XP und UCSX 9108 Module zeigt."]
...
image:sm-bcs-image7.png["Ein Diagramm, das die Frontplatten der Cisco UCS FI 6454, 64108, 6324, 6332 und 6332-16UP Modelle zeigt"]
...
image:sm-bcs-image8.png["Ein Diagramm, das Cisco UCS VIC 1440, 1467, 1455, 1480, 1477, 1457, 14825, 14425 und 14000 Bridge Cards zeigt"]
...
image:sm-bcs-image9.png["Ein Diagramm, das Cisco Nexus 9336C-FX2, 93180YC-FX3 und 3232C Switches zeigt"]
...
image:sm-bcs-image10.png["Ein Diagramm, das die Vorderansichten der Cisco MDS 9132T, 9148T, 9148S, 9250i und 9396T Switches zeigt"]
...
image:sm-bcs-image11.png["Ein Diagramm, das NetApp AFF und ASA Controller sowie DS 224C/2246 und NS 224 Festplattengehäuse zeigt"]
...
image:sm-bcs-image12.png["Ein Diagramm, das zwei FlexPod Standorte mit SM-BC-Beziehungen und einen ONTAP Mediator an Standort C zeigt"]
...
image:sm-bcs-image13.png["Ein Diagramm, das asymmetrische FlexPod Standorte zeigt, die durch erweiterte Layer-2-Verbindungen und ONTAP Mediator verbunden sind."]
...
image:sm-bcs-image14.png["Ein Diagramm, das von Intersight- und UCSM-verwaltete FlexPod Standorte zeigt, die über ein VXLAN Multi-Site-Fabric mit SM-BC-Beziehungen verbunden sind"]
...
image:sm-bcs-image15.png["Ein Diagramm, das FlexPod Zweigstellen zeigt, die über ein VXLAN Multi-Site-Fabric und ONTAP Mediator mit einem Rechenzentrum verbunden sind."]
