...
image:sm-bcs-image2.png["Ein Diagramm, das die FlexPod Datacenter-Komponenten zeigt: Cisco UCS, Nexus/MDS Switches und NetApp AFF/FAS/ASA Storage."]
...
image:sm-bcs-image3.png["Ein Diagramm, das die SnapMirror Synchronous Replikation und das automatische Failover zwischen primären und sekundären Rechenzentren veranschaulicht."]
