...
image:sm-bcs-image20.png["Ein Diagramm, das FI 6454, Nexus und AFF A250 mit redundanter lokaler Konnektivität zeigt"]
...
image:sm-bcs-image21.png["Ein Diagramm, das vPC-Peer-Links und standortübergreifende Verbindungen zwischen FlexPod Switches an den Standorten A und B darstellt."]
