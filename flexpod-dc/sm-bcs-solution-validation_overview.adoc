...
image:sm-bcs-image16.png["Ein Diagramm, das die FlexPod Standorte A und B zeigt, die durch erweiterte Layer-2- und SM-BC-Beziehungen mit ONTAP Mediator am Standort C verbunden sind."]
