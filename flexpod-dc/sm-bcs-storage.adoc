...
image:sm-bcs-image22.png["Ein Diagramm, das einen AFF A250 zeigt, der an Nexus A- und Nexus B-Switches an zwei Standorten angeschlossen ist"]
...
image:sm-bcs-image23.png["Ein Diagramm, das die mit Nexus verbundenen AFF A250 Controller-Ports, Schnittstellengruppen, VLAN-Ports und LIFs zeigt"]
...
image:sm-bcs-image24.png["Ein Diagramm, das die redundante iSCSI SAN-Boot-Konnektivität von B200 M5 Servern zu AFF A250 Controllern zeigt."]
...
image:sm-bcs-image25.png["Ein Screenshot des Dialogs „Intercluster-Schnittstellen hinzufügen“ im ONTAP System Manager mit zwei IP-Adressfeldern"]
...
+
image:sm-bcs-image26.png["Ein Screenshot des Dialogfelds „Passphrase generieren“ mit Cluster-Peer-Berechtigungen, Gültigkeit und einer kopierten Passphrase"]
...
+
image:sm-bcs-image27.png["Ein Screenshot, der den ONTAP System Manager Peer Cluster Dialog mit Passphrase und Intercluster-LIF-Adressen zeigt"]

. Im Teilfenster System Manager Protection > Overview werden Cluster-Peer-Informationen angezeigt.
+
image:sm-bcs-image28.png["Ein Screenshot der ONTAP System Manager Schutzübersicht, der den Cluster-Peer- und Mediator-Status anzeigt"]
...
image:sm-bcs-image29.png["Ein Screenshot des Dialogfelds „Mediator konfigurieren“ im ONTAP System Manager mit Mediator-Verbindungsfeldern"]
...
image:sm-bcs-image30.png["Ein Screenshot des ONTAP System Manager Schutzübersichtsbereichs, der den konfigurierten Mediator-Status anzeigt"]
...
image:sm-bcs-image31.png["Ein Screenshot des Dialogfelds „Konsistenzgruppe schützen“ mit Quellvolume esxi_a und Ziel-Cluster aff-a250-b"]
...
image:sm-bcs-image32.png["Ein Screenshot der ONTAP System Manager Beziehungen zeigt zwei intakte, synchronisierte Konsistenzgruppen an Standort A"]

In diesem Screenshot werden die Beziehungen zu Konsistenzgruppen an Standort B. angezeigt

image:sm-bcs-image33.png["Ein Screenshot der ONTAP System Manager Beziehungen an Standort B mit zwei fehlerfreien, synchronisierten Konsistenzgruppen"]

In diesem Screenshot werden die Details zur Consistency Group-Beziehung für die cg_Infra_Datastore_b-Gruppe angezeigt.

image:sm-bcs-image34.png["Ein Screenshot des ONTAP System Manager mit Details zur Konsistenzgruppenbeziehung der Konsistenzgruppe cg_infra_datastore_b"]
...
image:sm-bcs-image35.png["Ein Screenshot der ONTAP Volumeinformationen für Infra-SVM-a, einschließlich RW, DP und LS Volumes"]

Dieser Screenshot zeigt die Volume-Informationen für Standort B.

image:sm-bcs-image36.png["Ein Screenshot der ONTAP volume show-Ausgabe für Infra-SVM-b, in der neun Volumes einschließlich Ziel-DP-Volumes aufgelistet sind"]
...
image:sm-bcs-image37.png["Ein Screenshot, der die iSCSI Initiatorgruppen und LUN-Zuordnungen von Standort A in der ONTAP CLI-Ausgabe zeigt"]

In diesem Screenshot werden die Host-Initiatorgruppen und die LUN-Zuordnung für Standort B-Cluster angezeigt.

image:sm-bcs-image38.png["Ein Screenshot der Initiatorgruppe und der LUN-Mapping-Befehlsausgabe für iSCSI VMware Hosts auf Site B"]
