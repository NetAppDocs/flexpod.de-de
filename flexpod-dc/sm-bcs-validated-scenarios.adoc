...
image:sm-bcs-image47.png["Ein Diagramm, das ESXi iSCSI-Pfade durch zwei Fabrics zu primären und Ziel Konsistenzgruppe-LUNs zeigt."]
...
image:sm-bcs-image48.png["Ein Screenshot der Registerkarte „ESXi Storage Adapters Paths“, der zwei aktive (I/O)- und sechs aktive iSCSI-Pfade zeigt."]
...
image:sm-bcs-image49.png["Ein Screenshot des vSphere Client zeigt sechs iSCSI-Datenspeicher, die auf dem Host esxi-a-01.nva.local eingebunden sind."]
...
image:sm-bcs-image50.png["Ein Screenshot der vSphere Migrationsspeicherauswahl für iometer-a-01 mit iSCSI-Datenspeichern von Standort A und B"]
...
+
image:sm-bcs-image51.png["Ein Screenshot der ONTAP System Manager-Beziehungen mit dem Quelloptionenmenü, das Failover anzeigt"]

. Bestätigen Sie das Failover für den Start der Aktion.
+
image:sm-bcs-image52.png["Screenshot der ONTAP System Manager Bestätigung des geplanten Failovers für cg_esxi_a von Infra-SVM.1 zu Infra-SVM-b"]
...
image:sm-bcs-image53.png["Ein Screenshot des ONTAP System Manager zeigt Leistungsdiagramme von Standort A mit reduziertem IOPS und Durchsatz"]
...
image:sm-bcs-image54.png["Ein Screenshot des ONTAP System Manager Dashboards zeigt eine Leistung von 132,99K IOPS und einen Durchsatz von 1.038,58 MB/s"]
...
image:sm-bcs-image55.png["Ein Screenshot der ONTAP System Manager Relationships, der intakte, synchronisierte Konsistenzgruppen und eine Failover-Menüoption anzeigt."]
...
image:sm-bcs-image56.png["Ein Diagramm, das zeigt, dass der Speicher an Standort A nicht verfügbar ist und die SM-BC-Datendienste über ONTAP Mediator an Standort B weiterlaufen."]
...
image:sm-bcs-image57.png["Ein Screenshot des ONTAP System Manager Dashboards mit 80,32k IOPS und 626,98 MB/s Durchsatz"]

image:sm-bcs-image58.png["Ein Screenshot des ONTAP System Manager Dashboards für aff-a250-b mit 81,37k IOPS und 635,41 MB/s Durchsatz"]
...
image:sm-bcs-image59.png["Ein Screenshot des ONTAP System Manager zeigt eine deutlich gesteigerte IOPS- und Durchsatzleistung auf dem Cluster aff-a250-b"]
...
image:sm-bcs-image60.png["Ein Screenshot der ONTAP System Manager-Beziehungen zeigt zwei intakte Beziehungen, die nicht synchron sind."]
...
image:sm-bcs-image61.png["Ein Screenshot, der die Beziehungen des ONTAP System Managers mit dem Status „Gut“ und dem Zustand „Synchronisiert“ zeigt"]
...
image:sm-bcs-image62.png["Ein Screenshot des Dialogfelds „VM-/Hostregel bearbeiten“, in dem VMs von Standort A der Hostgruppe von Standort B zugewiesen werden"]
...
image:sm-bcs-image63.png["Ein Screenshot von zwei BMC CLI-Fenstern, die System-Ausschaltbefehle für aff-a250-a-01 und aff-a250-a-02 zeigen"]
...
image:sm-bcs-image64.png["Ein Screenshot eines Grafana Dashboards, der die SVM-Latenz, den Durchsatz und die IOPS-Metriken für Infra-SVM auf dem Cluster aff-a250-a anzeigt"]

image:sm-bcs-image65.png["Ein Screenshot des Grafana SVM Dashboards mit Diagrammen zu Latenz, Durchsatz und IOPS für Infra-SVM-b"]
...
image:sm-bcs-image66.png["Ein Screenshot der Microsoft SQL Server TPROC-C Buildoptionen mit 100 Lagerhäusern und 10 virtuellen Benutzern"]
...
image:sm-bcs-image67.png["Ein Screenshot des HammerDB Transaktionszählers zeigt einen kurzen Transaktionsabfall und die anschließende Wiederherstellung während der Erstellung von TPROC-C"]
...
image:sm-bcs-image68.png["Ein Screenshot des NAbox Grafana Dashboards zeigt, dass die Latenz, der Durchsatz und die IOPS-Metriken des Speicher-Clusters von Standort B auf null sinken."]
...
image:sm-bcs-image69.png["Ein Screenshot des NAbox Grafana Dashboards, der die SVM-Latenz, den Durchsatz und die IOPS-Metriken von Standort A zeigt"]
