...
image:sm-bcs-image39.png["Ein Diagramm, das VMware HA und vSphere Metro Storage Cluster über FlexPod Standorte A und B mittels einer Multi-Site-Fabric zeigt"]
...
image:sm-bcs-image40.png["Ein Diagramm, das Cisco UCS B200 M5 Server und AFF A250 Storage an den Standorten A und B zeigt, die über Nexus Switches und einen ONTAP Mediator am Standort C verbunden sind."]
...
image:sm-bcs-image41.png["Ein Diagramm, das die Switches vSwitch0, vDS0, iSCSI-A und iSCSI-B mit sechs vNIC Uplinks zeigt."]
...
image:sm-bcs-image42.png["Ein Screenshot, der VM-/Hostgruppen für Hosts und VMs an Standort A und Standort B in vSphere anzeigt"]
...
image:sm-bcs-image43.png["Ein Screenshot des Dialogfelds „VM-/Hostregel bearbeiten“, in dem VMs von Standort A so konfiguriert werden, dass sie auf Hosts von Standort A ausgeführt werden."]

image:sm-bcs-image44.png["Ein Screenshot des Dialogfelds „VM-/Hostregel bearbeiten“ für VMs und Hosts an Standort B mit einer Gruppenrichtlinie „Sollte auf Hosts in Gruppe ausgeführt werden“"]
...
image:sm-bcs-image45.png["Ein Screenshot der erweiterten vSphere HA-Optionen mit vier konfigurierten Heartbeat-Datenspeichern und zwei Isolationsadressen"]
...
image:sm-bcs-image46.png["Ein Screenshot der vSphere HA Heartbeat-Datenspeichereinstellungen mit vier ausgewählten Datenspeichern"]

Weitere Best Practices und Konfigurationen für VMware HA Cluster und VMware vSphere Metro Storage Cluster sind unter  https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.avail.doc/GUID-5432CA24-14F1-44E3-87FB-61D937831CF6.html["Erstellen und Verwenden von vSphere HA-Clustern"^], https://core.vmware.com/resource/vmware-vsphere-metro-storage-cluster-vmsc["VMware vSphere Metro Storage-Cluster (vMSC)"^] und  https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html["NetApp ONTAP mit SnapMirror active sync (ehemals SM-BC) und VMware vSphere Metro Storage Cluster (vMSC)"^] zu finden.
