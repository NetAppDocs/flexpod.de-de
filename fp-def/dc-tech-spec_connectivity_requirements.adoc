...
* Eigenständige Cisco UCS Fabric Interconnect Appliance Ports werden nur für iSCSI-Verbindungen empfohlen. Werden NAS-Verbindungen mit Appliance Ports verwendet, sind für bestimmte Ausfallszenarien zusätzliche Cisco Nexus oder gleichwertige Ethernet Switches erforderlich.
* Es können keine zusätzlichen Geräte zwischen den Kern-FlexPod-Komponenten angeordnet werden.


Uplink-Verbindungen:

* Die Ports der NetApp Storage-Controller müssen mit den Cisco Nexus 9000 Series Switches verbunden sein.
