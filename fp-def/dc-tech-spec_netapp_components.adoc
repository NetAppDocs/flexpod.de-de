...
Weitere Informationen zu den Festplattengehäusen und Speichermedien sind im Link „Technische Spezifikationen für Festplattengehäuse und Speichermedien“ in der folgenden Tabelle zu finden.

|===
| Festplatten-Shelf | Technische Spezifikationen 


| DS224C .4+| https://www.netapp.com/data-storage/disk-shelves-storage-media/["Technische Spezifikationen für Festplattengehäuse und Speichermedien"] 
