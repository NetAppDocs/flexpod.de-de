...
Die folgende Abbildung veranschaulicht das FlexPod Datacenter für FC mit Cisco MDS.
...
Weitere Informationen zur ONTAP Implementierung sind unter  https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684: Implementieren und Konfigurieren moderner SANs mit NVMe"^] zu finden.
