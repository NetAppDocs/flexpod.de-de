...
* *FlexPod Datacenter.* Diese Plattform ist eine hochskalierbare Rechenzentrumsinfrastruktur, die sich für Enterprise-Workloads und -Anwendungen, Virtualisierung, KI/ML, Datenbanken, SAP HANA, VDI sowie Public und Private Cloud eignet. FlexPod Datacenter verfügt über eigene Spezifikationen, die in https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["Technische Spezifikationen für FlexPod Datacenter"^] dokumentiert sind.
