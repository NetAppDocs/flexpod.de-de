...
* *FlexPod Datacenter.* Diese Plattform ist eine hochskalierbare virtuelle Rechenzentrumsinfrastruktur, die für Workload-Unternehmensanwendungen, Virtualisierung, VDI und öffentliche und private Cloud geeignet ist. FlexPod Datacenter hat seine eigenen Spezifikationen, die in https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["TR-4036: Technische Spezifikationen zu FlexPod Datacenter"^] dokumentiert sind.
