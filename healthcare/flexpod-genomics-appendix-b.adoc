...
summary: Dieser Abschnitt beschreibt die Ausführung der ./gatk-Ausgabe. 
---
...
link:flexpod-genomics-appendix-a.html["Zurück: Ausgabe für die Ausführung von GATK mit der JAR-Datei."]
...
link:flexpod-genomics-appendix-c.html["Weiter: Ausgabe für die Ausführung von GATK mit der Cromwell-Engine."]
