...
summary: Dieser Abschnitt zeigt die Ausgabe nach der Ausführung des GATK mit der Cromwell-Engine. 
---
...
....
link:flexpod-genomics-appendix-d-gpu-setup.html["Als Nächstes: GPU-Setup."]
