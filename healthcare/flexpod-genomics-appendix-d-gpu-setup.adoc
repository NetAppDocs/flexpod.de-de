...
+
image:flexpod-genomics-image18.png["Ein Screenshot der Registerkarte „GPUs“ im Cisco UCS Manager Inventory zeigt eine P6-Grafikkarte im Compute-Modus."]

+
image:flexpod-genomics-image19.png["Ein Screenshot von Cisco UCS Manager zeigt die GPU-Inventarisierung mit einer UCSB-GPU-P6-R im Compute-Modus"]
...
. Dieser Befehl installiert die  https://docs.nvidia.com/vgpu/latest/grid-software-quick-start-guide/installing-configuring-vgpu-manager-guest-driver.html#installing-the-nvidia-virtual-gpu-manager-on-vmware-vsphere["NVIDIA vGPU Manager"^] in ESXi.
+
....
...
+
image:flexpod-genomics-image20.png["Ein Screenshot des vSphere Client, der das für Shared Direct konfigurierte NVIDIA Tesla P6 Grafikgerät zeigt"]

+
image:flexpod-genomics-image21.png["Ein Screenshot von „Edit Graphics Device Settings“, wobei Shared Direct ausgewählt und „Restart X.Org server“ aktiviert ist."]
...
+
image:flexpod-genomics-image22.png["Ein Screenshot der vCenter VM-Startoptionen zeigt, dass die EFI-Firmware und Secure Boot deaktiviert sind."]
...
+
image:flexpod-genomics-image23.png["Ein Screenshot, der den Abschnitt „Erweiterte Einstellungen“ von vCenter mit einem Link „Konfiguration bearbeiten“ zeigt"]

+
image:flexpod-genomics-image24.png["Ein Screenshot des Dialogfelds „Konfigurationsparameter“, in dem pciPassthru.64bitMMIOSizeGB und pciPassthru.use64bitMMIO Werte aufgelistet werden"]
...
+
image:flexpod-genomics-image25.png["Ein Screenshot der vCenter Edit Settings zeigt das NVIDIA GRID vGPU-Profil grid_p6-16c, das für ein PCI-Gerät ausgewählt ist."]
...
+
image:flexpod-genomics-image26.png["Ein Screenshot der Seite „Licensed Clients“ des NVIDIA License Server, auf der ein virtueller Ethernet-Client aufgeführt ist"]
