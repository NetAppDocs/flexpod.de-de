...
image:flexpod-genomics-image2.png["Ein Diagramm, das Krankenhausanwendungen vereinheitlicht auf FlexPod mit Protokollen, Speicher und Cloud-Konnektivität zeigt"]
