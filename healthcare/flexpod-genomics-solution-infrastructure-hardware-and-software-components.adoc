...
image:flexpod-genomics-image6.png["Ein Diagramm, das FlexPod für Genomics mit Cisco UCS, Nexus, MDS und NetApp AFF A700 Konnektivität zeigt"]

Im folgenden Diagramm sind die Details zur FlexPod-Verkabelung dargestellt.

image:flexpod-genomics-image7.png["Ein Diagramm, das die Verkabelung von FlexPod für Genomics zwischen UCS, Nexus, NetApp AFF und MDS-Switches zeigt"]
