...
image:medical-imaging_image3.png["Ein Diagramm, das die FlexPod medizinische Bildgebungsinfrastruktur mit UCS, Nexus, AFF und MDS Switches zeigt"]
...
image:medical-imaging_image5.png["Ein Diagramm, das eine Gemeindeklinik zeigt, die über einen Enterprise Service Bus mit Krankenhaussystemen verbunden ist"]
...
Medizinische Bildgebungssysteme beginnen,  https://www.netapp.com/pdf.html?item=/media/7398-sb-flexpod-datacenter-ai.pdf["GPU-basierte Computing-Funktionen"^] einzusetzen, um menschliche Arbeitsabläufe durch die Vorverarbeitung der Bilder zu optimieren und so die Effizienz zu steigern. Typische medizinische Bildgebungssysteme in Unternehmen nutzen die branchenführenden NetApp Speichereffizienzfunktionen. Medizinische Bildgebungssysteme in Unternehmen verwenden in der Regel RMAN für Backup-, Recovery- und Restore-Aktivitäten. Für eine bessere Performance und zur Reduzierung der Zeit für die Erstellung von Backups steht die Snapshot Technologie für Backup-Operationen und die SnapMirror Technologie für die Replikation zur Verfügung.

Die Abbildung unten zeigt die logischen Applikationskomponenten in einer vielschichtigen Architekturansicht.

image:medical-imaging_image6.png["Ein Diagramm, das geschichtete medizinische Bildgebungskomponenten auf FlexPod mit replizierter Katastrophenwiederherstellung zeigt"]

Die Abbildung unten zeigt die physischen Applikationskomponenten.

image:medical-imaging_image7.png["Ein Diagramm, das aktive und Standby-FlexPod Rechenzentren mit NetApp ONTAP Storage und medizinischen Bildgebungsservern zeigt"]
