...
image:medical-imaging_image8.png["Ein Diagramm, das AFF A300 Knoten mit a0a ifgrps, VLANs sowie NFS- und iSCSI-LIFs zeigt"]
...
* Die NetApp Speicher-Array-basierte Replikationstechnologie namens  https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^] wird anstelle der vSphere-basierten Replikation verwendet.
