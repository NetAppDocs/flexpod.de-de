...
Das Gesundheitswesen, wie wir es kennen, basiert auf Leistungserbringern (Ärzten, Pflegekräften, Radiologen, Medizintechnikern usw.) und Patienten. Da Patienten und Leistungserbringer immer enger zusammenrücken und der geografische Standort nur noch ein Datenpunkt ist, wird es umso wichtiger, dass die zugrundeliegende Plattform verfügbar ist, wenn Leistungserbringer und Patienten sie benötigen. Die Plattform muss sowohl effizient als auch kostengünstig auf lange Sicht sein. In ihren Bemühungen, die Kosten der Patientenversorgung weiter zu senken, würden  https://www.cms.gov/priorities-innovation-key-concepts-accountable-care-accountable-care-organizations["Rechenschaftspflichtige Versorgungsorganisationen"^] (ACOs) durch eine effiziente Plattform unterstützt.
...
* Mobile Modalitäten, wie tragbare, drahtlose Scangeräte (zum Beispiel tragbare Ultraschallgeräte, die an ein Smartphone angeschlossen werden), erfordern eine robuste Netzwerkinfrastruktur mit Sicherheit, Zuverlässigkeit und Latenz auf DoD-Niveau am Rand, im Kern und in der Cloud.  https://www.netapp.com/blog/medical-imaging-cloud-disaster-recovery-meets-ai/["Eine Data-Fabric-Strategie von NetApp"^] bietet Unternehmen diese Fähigkeit im großen Maßstab.
* Neuere Modalitäten haben einen exponentiell steigenden Speicherbedarf; beispielsweise benötigen CT und MRT jeweils einige hundert MB, während digitale Pathologiebilder (einschließlich Ganzpräparat-Scans) mehrere GB groß sein können. FlexPod ist so konzipiert, dass  https://www.netapp.com/pdf.html?item=/media/16926-sb-flexpod-advantage-performance-agility-economics.pdf["Performance, Zuverlässigkeit und Skalierbarkeit sind grundlegende Merkmale"^].
...
image:medical-imaging_image2.png["Ein Diagramm, das das FlexPod Cooperative Support-Modell zwischen Kunden, Cisco und NetApp zeigt"]
