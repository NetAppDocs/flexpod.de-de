...
+
image:cloud-fabricpool_image14.png["Ein Screenshot, der das Navigationsmenü des OnCommand System Manager mit ausgewählten Anwendungen  Ebenen zeigt"]

. Klicken Sie Auf Storage Tiers.
. Klicken Sie auf ein Aggregat.
. Klicken Sie auf Aktionen und wählen Sie Cloud Tier anhängen.
+
image:cloud-fabricpool_image15.png["Ein Screenshot, der das Menü „Weitere Aktionen“ mit der Auswahl „Cloud Tier anhängen“ zeigt."]
