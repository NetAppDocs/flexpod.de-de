...
image:cloud-fabricpool_image10.png["Ein Diagramm, das gültige und ungültige FabricPool Aggregate-zu-Bucket-Zuordnungskonfigurationen zeigt"]
...
+
image:cloud-fabricpool_image11.png["Ein Screenshot der AWS-Konsolensuche, der das Ergebnis „S3 Scalable Storage in the Cloud“ hervorgehoben zeigt"]
...
+
image:cloud-fabricpool_image12.png["Ein Screenshot des AWS-Dialogs zum Erstellen eines Buckets mit Bucket-Name, Region und Schaltfläche „Erstellen“"]
