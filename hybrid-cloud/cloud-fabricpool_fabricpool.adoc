...
image:cloud-fabricpool_image4.png["Ein Diagramm, das die Snapshot-Only-Tiering-Methode zeigt, bei der Snapshot-Kopien von einem primären Cluster in den Cloud-Speicher verschoben werden."]
...
image:cloud-fabricpool_image5.png["Ein Diagramm, das das automatische Tiering zeigt, bei dem inaktive Daten vom primären Clusterspeicher in den Cloud-Speicher verschoben werden"]
