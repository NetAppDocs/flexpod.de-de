...
NOTE: Bitte informieren Sie sich im https://hwu.netapp.com/DetailViews/Home.aspx[] [NetApp Hardware Universe^] über die neuesten Informationen zu unterstützten Plattformen mit FabricPool.

* NetApp ONTAP Select [HINWEIS] NetApp empfiehlt die Verwendung von All-SSD-FabricPool-lokalen Tiers.
* Cloud-Tiers
+
