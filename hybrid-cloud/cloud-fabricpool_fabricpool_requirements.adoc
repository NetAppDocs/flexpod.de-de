...
image:cloud-fabricpool_image6.png["Ein Diagramm, das zwei NetApp AFF A300 Controller zeigt, die Intercluster-LIFs mit AWS S3 verbinden."]
...
image:cloud-fabricpool_image7.png["Ein Screenshot der ONTAP CLI Objektspeicher-Profilergebnisse, der die Latenz und den Durchsatz von PUT- und GET-Anfragen anzeigt"]
