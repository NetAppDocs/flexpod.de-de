...
image:cloud-fabricpool_image2.png["Ein Diagramm, das FlexPod Speicher, Cisco Nexus und MDS Switches sowie Cisco UCS Familien mit Konnektivitätshinweisen zeigt"]
...
image:cloud-fabricpool_image3.png["Ein Diagramm, das die Verbindungen von Cisco UCS, Nexus 93180YC-EX, AFF A300 und MDS 9148S zeigt"]
