...
image:cloud-fabricpool_image8.png["Ein Screenshot des OnCommand System Manager-Dialogfelds „Lizenzpakete hinzufügen“ mit den Schaltflächen „Dateien auswählen“ und „Hinzufügen“"]
...
image:cloud-fabricpool_image9.png["Ein Screenshot der ONTAP System Manager Lizenzdetails zeigt FabricPool Lizenzkapazität von 10 TB und aktuelle Kapazität von 0 Byte."]
