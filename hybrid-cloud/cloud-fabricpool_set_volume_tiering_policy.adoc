...
+
image:cloud-fabricpool_image16.png["Ein Screenshot, der den Dialog „Change Volume Tiering Policy“ mit erweiterten Optionen für die Tiering-Richtlinie zeigt"]
