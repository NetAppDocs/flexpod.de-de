...
image:cloud-insights_image2.png["Ein Diagramm, das Cisco UCS, Nexus Switches, NetApp AFF A800 Controller und MDS Switches zeigt, die durch Netzwerkverbindungen miteinander verbunden sind"]
...
* Analyse der Umgebung anhand der dem NetApp Digital Advisor bereitgestellten Daten zur Bewertung von Risiken des Speichersystems und Empfehlungen zur Speicheroptimierung.
