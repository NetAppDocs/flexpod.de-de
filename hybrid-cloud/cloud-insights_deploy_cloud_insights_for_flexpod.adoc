...
. Wechseln Sie zu https://www.netapp.com/data-infrastructure-insights/["https://www.netapp.com/data-infrastructure-insights/"^]
...
+
image:cloud-insights_image3.png["Ein vSphere Kontextmenü, in dem „Neue virtuelle Maschine“ unter den Clusteraktionen hervorgehoben ist"]
...
+
image:cloud-insights_image4.png["Ein Screenshot des Assistenten zur Auswahl eines Gastbetriebssystems mit Linux und Red Hat Enterprise Linux 7 (64-Bit) als ausgewählte Optionen"]
...
+
image:cloud-insights_image5.png["Ein Screenshot von VMware Customize hardware settings mit konfiguriertem CPU, Arbeitsspeicher, Festplatte, Netzwerk und CD/DVD-Laufwerk"]
...
+
image:cloud-insights_image6.png["Ein Screenshot des Bootmenüs von Red Hat Enterprise Linux 7.6 mit ausgewählter Option „Install“"]
...
+
image:cloud-insights_image7.png["Ein Screenshot, der eine ausgewählte 100 GiB VMware Virtual Disk und die Option für die manuelle Partitionierung zeigt"]
...
+
image:cloud-insights_image8.png["Ein Screenshot der manuellen Partitionierung von Red Hat Enterprise Linux mit 25 GiB /opt/netapp und /var/log/netapp Volumes"]
...
+
image:cloud-insights_image9.png["Ein Screenshot des Red Hat Enterprise Linux Network  Host Name-Bildschirms mit aktiviertem Ethernet und eingegebenem Hostnamen"]
...
+
image:cloud-insights_image10.png["Ein Screenshot des Installationsabschlussbildschirms von Red Hat Enterprise Linux mit einer Neustart-Schaltfläche"]
...
+
image:cloud-insights_image11.png["Ein Terminal zeigt die erfolgreiche Registrierung mit dem Red Hat Subscription Manager für das Netapp-AU System an."]

. Fügen Sie ein verfügbares Abonnement für Red hat Enterprise Linux bei.
+
image:cloud-insights_image12.png["Ein Terminal, das die erfolgreiche Verbindung eines Red Hat Enterprise Linux Abonnements anzeigt."]
...
+
image:cloud-insights_image14.png["Ein Screenshot, der die Registerkarten „Datensammler“ und „Erfassungseinheiten“ zeigt, wobei „Erfassungseinheiten“ ausgewählt ist"]

. Um eine neue Akquisitionseinheit zu erstellen, klicken Sie auf die Schaltfläche auf der rechten Seite.
+
image:cloud-insights_image15.png["Ein Screenshot, der die Schaltfläche „Erfassungseinheit hinzufügen“ und ein Filterfeld zeigt"]
...
+
image:cloud-insights_image16.png["Ein Screenshot, der die Installationsanweisungen und den Installationsausschnitt der Cloud Insights Linux Acquisition Unit zeigt"]

. Fügen Sie das Snippet in die CLI des bereitgestellten Red hat Enterprise Linux-Rechners ein, und klicken Sie auf Enter.
+
image:cloud-insights_image17.png["Ein Terminalfenster zeigt einen Token-Befehl zur Installation der Cloud Insights acquisition unit unter Linux."]
...
+
image:cloud-insights_image18.png["Ein Terminal zeigt die erfolgreiche NetApp Cloud Insights Acquisition Unit Installation und Registrierung an."]
...
+
image:cloud-insights_image19.png["Ein Screenshot der Zusammenfassung der NetApp AU Acquisition Unit mit Anzeige von IP, OK-Status und zuletzt gemeldeter Zeit"]
...
+
image:cloud-insights_image20.png["Ein Screenshot, der die gefilterten ONTAP Datensammleroptionen auf der Seite „Datensammler hinzufügen“ zeigt."]
...
+
image:cloud-insights_image21.png["Ein Screenshot der Seite „Collector konfigurieren“ mit validierten ONTAP Anmeldeinformationen und Einstellungen der Acquisition Unit."]
...
+
image:cloud-insights_image22.png["Ein Screenshot einer Cloud Insights Datensammlerzeile, der den Abfragestatus von FlexPod Datacenter anzeigt"]
