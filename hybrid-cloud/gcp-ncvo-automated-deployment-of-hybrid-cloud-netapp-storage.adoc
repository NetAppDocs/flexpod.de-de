...
https://github.com/ucs-compute-solutions/cvo_snapmirror["Dieser GitHub-Link"^]Stellt die Terraform-Konfiguration mit verschiedenen Ressourcen bereit. Dieses Repository kann geforkt und eine Kopie im eigenen GitHub Konto erstellt werden.
