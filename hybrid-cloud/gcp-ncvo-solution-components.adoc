...
Weitere Informationen zur Intersight-Lizenzierung und den in den einzelnen Lizenzen enthaltenen Funktionen sind hier zu finden https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Hier"^].
...
Nachdem Intersight Assist in Intersight eingebunden wurde, können Endgeräte über die Option „Claim Through Intersight Assist“ eingebunden werden. Weitere Informationen finden sich unter  https://intersight.com/help/saas/getting_started/overview["Erste Schritte"^].
