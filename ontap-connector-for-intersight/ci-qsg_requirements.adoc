...
NOTE: Informationen zu den Mindestanforderungen für Cisco UCS Compute Components und die UCSM-Version sind in  https://intersight.com/help/saas/supported_systems/overview["Von Cisco Intersight unterstützte Systeme"^] zu finden.
...
Weitere Informationen zu den in den verschiedenen Lizenzstufen enthaltenen Funktionen sind unter  https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Infrastructure Services Lizenz"^] verfügbar.
