...
image:flexpod-fips-image3.png["Ein Diagramm, das den Datenfluss von verschlüsselten Schreib- und entschlüsselten Lesedaten durch Netzwerk, WAFL, RAID und Speicher mit einem kryptografischen Modul zeigt"]
...
image:flexpod-fips-image4.png["Ein Diagramm, das die Verschlüsselung und Entschlüsselung durch Netzwerk-, WAFL-, RAID- und Speicherkryptografiemodulschichten zeigt"]
...
image:flexpod-fips-image5.png["Ein Diagramm, das die ONTAP kryptografische Grenze mit den Komponenten Schlüsselmanager, cryptomod und cryptomod_fips zeigt"]
