...
image:flexpod-fips-image6.png["Ein Diagramm, das FIPS 140-2-konforme FlexPod Verbindungen für Compute-, Netzwerk- und Storage-Systeme im Gesundheitswesen zeigt"]
